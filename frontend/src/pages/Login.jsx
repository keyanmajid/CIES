...
import { useCart } from "../context/CartContext"; // ✅ assuming your cart context is here

const Login = () => {
  const navigate = useNavigate();
  const { cartCount, isAuthenticated, userName } = useCart();
 ...
 const handleLogin = async (e) => {
  ...
  try {
    ...
    if (res.ok) {
      ...
      // ✅ FIX: Use result.user.role instead of result.role
      ...
      switch (role) {
        case "customer":
          ...
          break;
        case "employee":
          navigate("/chat/employee");
          break;
        case "manager":
          navigate("/care"); // or /manager-dashboard if you prefer
          break;
        default:
          navigate("/");
      }
