...
# ------------------------------
# Load 5-day sales model (Safe)
# ------------------------------
import os
if not os.path.exists("sales_model_5days.pkl"):
    raise FileNotFoundError("sales_model_5days.pkl not found in /app")
